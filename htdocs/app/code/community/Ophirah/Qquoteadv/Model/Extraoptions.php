...
class Ophirah_Qquoteadv_Model_Extraoptions extends Mage_Sales_Model_Quote
{
    ...
    public function getAllOptionsToAdd($typesToAdd)
    {
        ...
        // EXAMPLE
        /*
        if(in_array(self::OPTION_TYPE_SHIPPING_SERVICE, $typesToAdd) && Mage::getStoreConfig('qquoteadv/quote_form/require_delivery_options') > 0 ){
    ...
    public function getShippingService()
    {
        ...
        $selected = explode(',', Mage::getStoreConfig('qquoteadv/quote_form/delivery_options'));
        ...
        $vars['required'] = (Mage::getStoreConfig('qquoteadv/quote_form/require_delivery_options') == 2) ? true : false;
